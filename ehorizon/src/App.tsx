...
export default function EHorizon() {
  ...
  const goToRegister = (url) => {
    window.location.href = url; // replace with react-router navigate if you use routes
  };
  ...
  const pitchEvent = {
    ...
    registerUrl: "/registration", // ✅ change to your real registration page URL
  };

  // ✅ 10 standard events (each has Register)
  const events = [
    {
      title: "Event 1",
      image: event1,
    ...
    {
      title: "Data Science",
      image: "/assets/events/data-science.jpg",
      registerUrl: "/registration",
    },
    {
      title: "Cloud",
      image: "/assets/events/cloud.jpg",
      registerUrl: "/registration",
    },
    {
      title: "Mobile Dev",
      image: "/assets/events/mobile.jpg",
      registerUrl: "/registration",
    },
    {
    ...
    {
      title: "UI/UX",
      image: "/assets/events/uiux.jpg",
      registerUrl: "/registration",
    },
    {
      title: "Web Security",
      image: "/assets/events/secure-web.jpg",
      registerUrl: "/registration",
    },
  ];
    ...
    <>
      ...
      <div className="bg-black text-white min-h-screen overflow-x-hidden">
        ...
        <section id="home" className="relative min-h-screen pt-28 flex items-center justify-center">
          ...
          {/* bottom meta */}
          <div className="absolute bottom-16 left-1/2 -translate-x-1/2 z-10 px-6 w-full">
              ...
              <div className="grid lg:grid-cols-2">
                ...
                <div className="p-8 md:p-10">
                  ...
                  <div className="mt-8 flex flex-col sm:flex-row gap-4">
                    <button
                      onClick={() => goToRegister(pitchEvent.registerUrl)}
